...
<a href="#" class="brand-link logo-switch">
  <img src="{{ url_for("static", filename="dist/img/logo-xs.png") }}" alt="AdminLTE Docs Logo Small" class="brand-image-xl logo-xs">
  <img src="{{ url_for("static", filename="dist/img/logo-xl.png") }}" alt="AdminLTE Docs Logo Large" class="brand-image-xs logo-xl" style="left: 12px">
</a>
```
